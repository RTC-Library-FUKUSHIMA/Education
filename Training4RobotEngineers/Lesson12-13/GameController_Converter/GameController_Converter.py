...
"""
 @file GameController_Converter.py
 @brief GameController_Converter component
 @date $Date$
...
gamecontroller_converter_spec = ["implementation_id", "GameController_Converter", 
		 "type_name",         "GameController_Converter", 
		 "description",       "GameController_Converter component", 
		 "version",           "1.0.0", 
		 "vendor",            "VenderName", 
		 "category",          "Category", 
...
##
# @class GameController_Converter
# @brief GameController_Converter component
# 
# 
class GameController_Converter(OpenRTM_aist.DataFlowComponentBase):
...
def GameController_ConverterInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=gamecontroller_converter_spec)
    manager.registerFactory(profile,
                            GameController_Converter,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    GameController_ConverterInit(manager)

    # Create a component
    comp = manager.createComponent("GameController_Converter")
